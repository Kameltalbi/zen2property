...
assert.equal(resolvePricingMarket('CA').plans.smart.monthly, 1499);
assert.equal(resolvePricingMarket('CA').plans.premium.monthly, 2999);
assert.equal(resolvePricingMarket('US').plans.premium.monthly, 1999);
assert.equal(resolvePricingMarket('EU').plans.smart.monthly, 990);
assert.equal(resolvePricingMarket('TN').plans.smart.monthly, 999);
